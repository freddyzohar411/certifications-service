...
public class CertificationsControllerTest {
	...
	public void setUp() {
		...
		this.mockMvc = MockMvcBuilders.standaloneSetup(certificationsController).build();
	}
	...
	@Test
	void testCreateCertificationsPositive() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		mapper.configure(SerializationFeature.WRAP_ROOT_VALUE, false);
		RequestBuilder request = MockMvcRequestBuilders.post("/api/certifications/add")
				.content(asJsonString(new CertificationsRequestDTO("entityType", 1, formData, 1, 1L, 1L)))
	...
	@Test
	void testCreateCertificationsNegative() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		mapper.configure(SerializationFeature.WRAP_ROOT_VALUE, false);
		RequestBuilder request = MockMvcRequestBuilders.post("/api/certifications/add")
				.content(asJsonString(new CertificationsRequestDTO("entityType", 1, formData, 1, 1L, 1L)))
	...
	@Test
	void testGetCertificationsByEntityTypeAndEntityId() throws Exception {
		mockMvc.perform(
				MockMvcRequestBuilders.get("/api/certifications/entity/{entityType}/{entityId}", "entityType", 1))
				.andExpect(status().isOk()).andReturn();
	}

	@Test
	void testDeleteCertifications() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.delete("/api/certifications/{id}", 1)).andExpect(status().isOk())
				.andReturn();
	}

	@Test
	void testUpdateCertificationsPositive() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		mapper.configure(SerializationFeature.WRAP_ROOT_VALUE, false);
		ObjectWriter writer = mapper.writer().withDefaultPrettyPrinter();
		String requestJson = writer.writeValueAsString(certificationsRequestDTO);
		RequestBuilder request = MockMvcRequestBuilders.put("/api/certifications/{id}", 1).content(requestJson).header(
				"Authorization",
				"Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICI0WndUaGhXVUtGSjhUdE1NdFZrcm1Edk9TdGdRcS1Sa3MwUnEwRE5IRG5jIn0..A314CP_nu6x3qENsK8fyZP8SXXJO9y1nAcUXHU2FRRZ2vtPjD-T6rUoHQ_CZgMXnPg4Rl4MOlSCQ5leTiWix9kfBYkDQGar7GPSf9UnnPai7adiLV8Rb6OUYykHPjN_Wy3A0CVyGbsBB1ow7uhmgPkM7aMBUUYikkYK0aLremKn9vXJCpC7G2UTCW_BOjl7Bb5atic3J328ieN8nu0_W_Zd61ux1zm7skX4TPLNTC-4dAc16O-6IOo6JChQLUublfm-CcVC_i7oIv0Nuw7hOj5m5_e0klNcK-dw9bArBkRCGU9Sr4ieFIkjaLxt22Z3ZDg0C9SeB268OvnKXrjDKiQ")
				.contentType(MediaType.APPLICATION_JSON_VALUE).accept(MediaType.APPLICATION_JSON);
	...
	@Test
	void testUpdateCertificationsNegative() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		mapper.configure(SerializationFeature.WRAP_ROOT_VALUE, false);
		ObjectWriter writer = mapper.writer().withDefaultPrettyPrinter();
		String requestJson = writer.writeValueAsString(certificationsRequestDTO);
	...
	@Test
	void testDeleteCertificationsByEntityTypeAndEntityId() throws Exception {
		mockMvc.perform(
				MockMvcRequestBuilders.delete("/api/certifications/entity/{entityType}/{entityId}", "entityType", 1))
				.andExpect(status().isOk()).andReturn();
	}
}
